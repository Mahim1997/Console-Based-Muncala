...
public class AlphaBeta_Min extends MiniMax_MinPlayer {

    @Override
    public int getBestMove(GameState state, int depth) {

        if (depth <= 0) {
//            System.out.println("-->>In getBestMove Alpha Beta() of AlphaBeta_PlayerMin ... depth given is <= 0 ... return -1");
            return -1;
        }
...
//        System.out.println("ALPHA_BETA" + state.getWhoseTurn() + " is thinking ... "
//                + " with depth = " + depth);
...
//                + " best Move idx = " + bestMove + " for alphaBetaMin depth = " + depth);
        return bestMove;
    }
